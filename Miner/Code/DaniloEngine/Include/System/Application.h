...
namespace GameSystem
{
	...
	public:
		...
		/// </summary>
		GameCodeApp(std::unique_ptr<EntitySystem> entitySystem,std::shared_ptr<GameLogic> gameLogic,std::unique_ptr<PhysicsSystem> physicsSystem);
		/// <summary>
	...
	protected:
		...
		std::shared_ptr<GameLogic>				m_pGame; //The AI GameLogic

...
SimBinGameLogic * g_pGameLogic;
using namespace AI;
/// <summary>
/// Initializes a new instance of the <see cref="SimBinGameLogic"/> class.
/// </summary>
/// <param name="lives">The lives.</param>
SimBinGameLogic::SimBinGameLogic(uint32_t lives, std::shared_ptr<World> world) :m_Score(0), m_Lives(lives), m_State(SB_Initializing), m_RenderDiagnostics(false), m_pWorld(world)
{
...
void SimBinGameLogic::Reset()
{
	...
	//TODO: Move to Miner Project
	IEventManager::Get()->VAddListener(m_pAiEventListener, EvtData_StoneMovementRequested::sk_EventType);
	m_BehaviourList.clear();
}

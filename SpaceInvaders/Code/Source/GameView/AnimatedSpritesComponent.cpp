...
AnimatedSpritesComponent::AnimatedSpritesComponent(uint32_t ownerId,uint32_t posX, uint32_t posY,std::vector<std::string> &sprites, uint32_t idleSprite) :IGraphicsComponent(ownerId,posX,posY)
{
